...
public:
    ...
    bool is_supported() final;

    Result<void, FileDescriptor> compile(FilePath source, const CompileOptions& options) final;
...
protected:
    virtual sandbox::Result is_supported_impl(const CompileOptions& options) = 0;
